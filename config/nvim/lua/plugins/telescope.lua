...
return {
  {
    ...
    config = function()
      ...
      map("n", "<leader>sr", require("telescope.builtin").git_files, "Repository files")
      map("n", "<leader>sj", require("telescope.builtin").jumplist, "Jump list")
      map("n", "<leader>sb", require("telescope.builtin").buffers, "Buffers")
      map("n", "<leader>sy", require("telescope.builtin").current_buffer_fuzzy_find, "Current buffer")
